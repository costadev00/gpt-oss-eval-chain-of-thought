...
\url{https://github.com/costadev00/gpt-oss-eval-chain-of-thought}. O
repositorio foi organizado para separar claramente os dois experimentos:
\texttt{experiments/01\_chain\_of\_thought/} contem a avaliacao de CoT, e
\texttt{experiments/02\_process\_supervision/} contem o teste de Process
...
\texttt{cot\_eval/run.py} & Ponto de entrada do experimento CoT versus resposta
direta. \\
\texttt{cot\_eval/prompts.py} & Prompts e contrato de saida usados nas
condicoes \emph{standard} e CoT. \\
\texttt{cot\_eval/tasks.py} & Carregamento de GSM8K e geracao deterministica
das tarefas Last Letter e Coin Flip. \\
\texttt{cot\_eval/audit\_parser.py} & Auditoria offline do parser sem nova
chamada ao modelo. \\
\texttt{cot\_eval/prm\_run.py} & Ponto de entrada do experimento de Process
Supervision promptado. \\
\texttt{cot\_eval/math\_tasks.py} & Carregamento e normalizacao numerica do
benchmark MATH. \\
\texttt{cot\_eval/prm\_scoring.py} & Divisao de solucoes em passos, calculo de
scores PRM e majority vote. \\
\texttt{experiments/01\_chain\_of\_thought/} & README proprio e artefatos
preservados da rodada principal de CoT. \\
\texttt{experiments/02\_process\_supervision/} & README proprio e artefatos
preservados da rodada principal de Process Supervision. \\
\texttt{reports/gpt\_oss\_20b\_cot\_prm\_report.tex} & Fonte deste artigo
consolidado. \\
\bottomrule
\end{tabular}
\end{table}
...
ficam em
\texttt{experiments/01\_chain\_of\_thought/artifacts/20260510-185218/}.
...
principal ficam em
\texttt{experiments/02\_process\_supervision/artifacts/20260510-231913/}.
...
\url{https://github.com/costadev00/gpt-oss-eval-chain-of-thought}.
...
\newblock \url{https://github.com/costadev00/gpt-oss-eval-chain-of-thought}.
